...
## ACCENT VS. DIALECT CONSTRAINT (STAGE 3)

Language controls the written lyric language. LYRIC DIALECT controls grammar and vocabulary. Vocal accent controls delivery only.

* Preserve the requested Language during humanization, including when a vocal accent is set. Never translate non-English lyrics into English merely to satisfy an accent setting.
* When LYRIC DIALECT = Nigerian Pidgin, preserve native Pidgin grammar and vocabulary; never normalize it to standard English.
* For English lyrics with no requested dialect, use natural, conversational English. Ordinary contractions and colloquial phrasing are allowed; do not invent a regional dialect from the accent alone.
* Keep accent instructions in existing performance/staging tags. Do not introduce phonetic accent spellings into lyric lines.
