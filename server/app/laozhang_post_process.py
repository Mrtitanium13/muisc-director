"""LaoZhang runtime pipeline: Claude theme → humanization → Suno compression."""
...
def run_laozhang_post_process(
    ...
    *,
    ...
    """
    Claude theme → humanization → compression (same Suno caps as OpenRouter).
    ...
    suffix = ":".join(labels)
    if suffix:
        logger.info("laozhang post-process chain: %s", suffix)
